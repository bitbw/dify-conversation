  ...
  return (
    <div
      className={cn(
        ...
        status === 'succeeded' && 'border-[rgba(23,178,106,0.8)] bg-workflow-display-success-bg bg-[url(../components/workflow/run/assets/bg-line-success.svg)] text-text-success',
        ...
        status === 'partial-succeeded' && 'border-[rgba(23,178,106,0.8)] bg-workflow-display-success-bg bg-[url(../components/workflow/run/assets/bg-line-success.svg)] text-text-success',
        ...
        status === 'failed' && 'border-[rgba(240,68,56,0.8)] bg-workflow-display-error-bg bg-[url(../components/workflow/run/assets/bg-line-error.svg)] text-text-warning',
        ...
        status === 'stopped' && 'border-[rgba(247,144,9,0.8)] bg-workflow-display-warning-bg bg-[url(../components/workflow/run/assets/bg-line-warning.svg)] text-text-destructive',
        ...
        status === 'exception' && 'border-[rgba(247,144,9,0.8)] bg-workflow-display-warning-bg bg-[url(../components/workflow/run/assets/bg-line-warning.svg)] text-text-destructive',
        ...
        status === 'running' && 'border-[rgba(11,165,236,0.8)] bg-workflow-display-normal-bg bg-[url(../components/workflow/run/assets/bg-line-running.svg)] text-util-colors-blue-light-blue-light-600',
    ...
    >
      <div className={cn(
        ...
        theme === Theme.light && 'bg-[url(../components/workflow/run/assets/highlight.svg)]',
        theme === Theme.dark && 'bg-[url(../components/workflow/run/assets/highlight-dark.svg)]',
      )}></div>
      {children}
    </div>
  )
